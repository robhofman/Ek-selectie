...
$(document).ready(function(){
	$('#btnHidden').click(function(){
        ...
        document.getElementById("rootTwitter").innerHTML = '<a href="https://twitter.com/share" class="twitter-share-button btnSocial" data-url="'+sharelink+'"data-text="Dit is mijn selectie" data-via="sporza" data-lang="nl">Tweeten</a>';
        setTimeout(function(){
